  ...
  return (
    <div style={{ maxWidth: 500, margin: "0 auto", padding: 20 }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: 16 }}>
        <button style={{ minWidth: 120, fontSize: 18, whiteSpace: "nowrap" }}>清除最后一条报文</button>
        <button style={{ minWidth: 120, fontSize: 18, whiteSpace: "nowrap" }}>清除所有报文</button>
      </div>
    </div>
  )
}
